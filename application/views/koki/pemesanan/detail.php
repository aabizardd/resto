...
<div class="box">
    ...
    <div class="box-body">
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><input type="radio" name="status_transaksi<?=$no ?>" value="Terima" <?php if ($value['status_transaksi'] == "Terima") { ?> checked=checked <?php } ?> required=""></td>
                <td><input type="radio" name="status_transaksi<?=$no ?>" value="Tolak" <?php if ($value['status_transaksi'] == "Tolak") { ?> checked=checked <?php } ?> required=""></td>
                <td><input type="text" name="catatan_status_detail<?=$no ?>" class="form-control" value="<?php echo $value['catatan_status_detail']; ?>"></td>
              </tr>
              <?php
              $no++;
              }
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <button type="submit" type="submit" class="btn btn-success pull-right" style="margin-right: 5px;"><i class="fa fa-check"></i> Konfirmasi</button>
        </div>
      </div>
      <?php form_close(); ?>
    </div>
