...
class MProdukkategori extends CI_Model {
    ...
    var $idtable = 'id_produk_kategori';
    ...
    var $order = array('id_produk_kategori' => 'asc'); // default order 
...
/* End of file Mprodukkategori.php */
/* Location: ./application/models/Mprodukkategori.php */